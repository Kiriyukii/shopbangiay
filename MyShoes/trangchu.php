        ...
        <div class="content">
            ...
            <div class="listPro">
                ...
                <div class="pro">
                    ...
                    <p class="type">NEW</p>
					<a href="/shopbangiay/MyShoes/chitietsanpham.php?idsp=<?php echo $row["id"]; ?>&soluong=1" class="name"><?php echo $row["ten_san_pham"]; ?></a>
                    <p class="discount"><s><?php if($gia != 1) echo $row["gia"]." đ"; ?></s></p>
                    <p class="price"><?php echo ($row["gia"]*$gia); ?> <u>đ</u></p>
                </div>
                <?php
				}
				?>
        ...
        <div class="content">
            ...
            <div class="listPro">
                ...
                <div class="pro">
                    ...
                    <img src="./admin/qlsp/anh/<?php echo $row["hinh_anh"];?>" alt="" class="imgSecond">
                    <p class="type">HOT</p>
                    <a href="/shopbangiay/MyShoes/chitietsanpham.php?idsp=<?php echo $row["idSP"]; ?>&soluong=1" class="name"><?php echo $row["ten_san_pham"]; ?></a>
                    <p class="discount"><s><?php if($gia != 1) echo $row["gia"]." đ"; ?></s></p>
                    <p class="price"><?php echo ($row["gia"]*$gia); ?> <u>đ</u></p>
                </div>
                <?php
