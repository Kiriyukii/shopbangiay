    ...
    <form action="danhmcsanpham.php" method="get">
        ...
        <div id="body-content">
            ...
            <div id="timkiemtheo">
                ...
                <div class="theogia">
                    <p>GIÁ</p>
                    <input type="text" name="giabatdau" id="giabd" value="<?=$giabd?>" class="giabatdau">đ
                    <input type="text" name="giaketthuc" id="giakt" class="giaketthuc" value="<?=$giakt?>">đ
                </div>
            ...
            <div id="noidung-sanpham">
                ...
                <img src="../image/quang_cao.png" alt="" class="img-quangcao">
                <div class="sap-xep">
                    <div>Sắp xếp theo: 
