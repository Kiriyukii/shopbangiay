...
<body>
    ...
    <div id="chitietsanpham">
        ...
        <div class="thong-tin-san-pham">
            <p class="ten-san-pham"><?=$rowSP["ten_san_pham"]?></p>
            <div class="gia-tinh-trang">
                <div class="gia"><strong><?=currency_format($rowSP["gia"]*$soluong * (100-$rowPhanTramSale['phan_tram'])/100)?></strong> <del><?=currency_format($rowSP["gia"]*$soluong)?></del></div>
                <div class="tinh-trang">
                    ...
                    <p>
                        <i class="ti-control-record"></i> Mã sản phẩm: <?= $rowSP["id"]?>
                    </p>
                </div>
            </div>
            <div class="clear"></div>
                <div class="chon-size">
                    ...
                    <div class="size">
                        <?php while($size = mysqli_fetch_array($qrLaySize)) {
                            ?>
                        <input type="button" value="<?= $size["loai_size"]?>" name="laysize" class="loai-size" id="<?= $size["loai_size"]?>" onclick="chonSize('<?= $size["loai_size"]?>')">
        ...
        <div class="mo-ta-san-pham">
            ...
            <div class="lien-he">
                ...
                <p><b>- Đổi hàng trong 30 ngày. </b><i>(Áp dụng với sản phẩm chưa sử dụng, nguyên vẹn như khi nhận hàng)</i></p>
                <p><b>- Bảo hành 6 tháng với các lỗi của nhà sản xuất, hậu mãi trọn đời.</b></p>
                <div class="chu-do">* Cách thức mua hàng:</div>
                <p>Khách hàng tiến hành MUA HÀNG trực tiếp tại các showroom hoặc trên website https://tbg.vn hoặc gọi điện tới Hotline: 0973 711 868 để được tư vấn.</p>
