    ...
    <div class="main">
            ...
            <div class="information-user">
                    ...
                    <div class="address-user">
                        ...
                        <input type="text" placeholder="Địa chỉ nhận hàng..." class="import_infor" name="diachinhan" required/><br>
                    </div>
                </div>
        ...
        <div class="information-deliver">
            <div class="chon-ship-payment">
                ...
                <div class="method-pay">
                    <h4 class="title">PHƯƠNG THỨC THANH TOÁN</h4>
                        ...
                        <input type="radio" checked value="Thanh toán khi nhận hàng" name="pttt"/>Thanh toán khi nhận hàng <br>
            ...
            <div class="list-product">
                    ...
                    <table style="width:100%; text-align: center; border-collapse: collapse;" border="1">
                        ...
                        <?php foreach($arrSanPham as $keys=>$vals) { ?>
                            <tr>
                                <td style="padding:10px;"><img src="../admin/qlsp/anh/<?=$vals[3]?>" width="100px" height="100px"></td>
                                <td><?=$vals[0]?></td>
                                <td><?=$vals[5]?></td>
                                <td><?=$vals[2]?></td>
            ...
            <input class="button_muahang" type="submit" value="Mua hàng" name="muahang" class="mua-hang" onclick="showConfirmation()">   
        </div>
