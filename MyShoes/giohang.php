   ...
   <?php
    ...
    <div class="main">
        <div class="main_content">
            <div style="padding: 20px;"><h3>GIỎ HÀNG CỦA BẠN</h3></div>
            <div class="content">
                        ...
                        <td>
                            <div class="chon-so-luong">
                                ...
                                <div class="nut-tang-giam">
                                    <div class="tang" onclick="Tang(<?=$val[2]?>, '<?=$val[5]?>', '<?=$val[4]?>')"><i class="ti-angle-up"></i></div>
                                    <div class="giam" onclick="Giam(<?=$val[2]?>, '<?=$val[5]?>', '<?=$val[4]?>')"><i class="ti-angle-down"></i></div>
                                </div>
                                <div class="loaibo">
                                    <button class="remove" onclick="XoaSanPham('<?=$val[5]?>', '<?=$val[4]?>')"><i class="ti-close"></i></button>
                                </div>
                                <div class="clear"></div>
                            </div>
                        </td>
                        <td><?=currency_format($val[1])?></td>
						<td><?php echo $val[6]."%"; ?></td>
                        <td><?=currency_format($val[1]*$val[2])?></td>
                        <?php 
        ...
        <div class="thanhtoan">
            <div class="tongtien">
                <table style="text-align: right; width: 100%;">
                    <tr >
                        <th>Thành tiền:</th>
                        <th><?php echo currency_format($tongtien); ?></th>
                    </tr>
                    <tr>
